...
import { watches, brands, conditions } from "@/lib/mock-data"
...
export default function InventoryPage() {
  ...
  const maxPrice = Math.max(...watches.map((w) => w.price))
  ...
  }, [searchQuery, selectedBrands, selectedConditions, priceRange])
